...
struct SupabaseEmergencyAccessRequest: Codable, Identifiable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case mlRecommendation = "ml_recommendation"
    ...
    init(
        ...
        self.mlRecommendation = mlRecommendation
    ...
    init(from request: EmergencyAccessRequest) {
        ...
        self.passCode = request.passCode
        self.mlScore = request.mlScore
        self.mlRecommendation = request.mlRecommendation
