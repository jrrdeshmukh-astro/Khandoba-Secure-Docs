...
object AppConfig {
    ...
    const val PROFILE_PICTURES_BUCKET = "profile-pictures"
    
    // Supabase Storage Configuration
    const val STORAGE_PUBLIC_URL = "$SUPABASE_URL/storage/v1/object/public"
    const val STORAGE_UPLOAD_MAX_SIZE_MB = 100 // Maximum file size in MB
    
    // Real-time Configuration
    const val ENABLE_REALTIME = true
    const val REALTIME_CHANNELS = listOf("vaults", "documents", "nominees", "chat_messages", "vault_sessions")
